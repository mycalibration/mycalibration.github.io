...
- **/samples**
  - **[/data-model/KellerSensorData.cs](https://github.com/mycalibration/mycalibration.github.io/blob/main/samples/data-model/KellerSensorData.cs)** - *Example of a C# data model that can handle JSON files using the schema.*
  - **/api/**
