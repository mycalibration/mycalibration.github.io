...
namespace myCalibrationAPISimpleSample
{
    ...
    {
      private const string PermanentAccessToken =
        "bqCrDAQABACUKUpXST6JCEgPeStCyeHhfmNz/+yE29F+VbVeKl7eU....  ASK engineering@keller-druck.com for your permanent acces token or look into the profile settings at https://mycalibration.azurewebsites.net/";
        ...
        static void Main(string[] args)
        {
            ...
            if (calibrationData.Count > 0)
            {
                ...
                if (sampleData.CompensationMethods?.MathematicalModels != null)
                {
                    ...
                    // JSON data can also be extracted with JObject:
