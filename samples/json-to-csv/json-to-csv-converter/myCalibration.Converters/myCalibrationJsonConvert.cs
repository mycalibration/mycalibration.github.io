...
namespace myCalibration.Converters
{
    ...
    {
        const int TextAlignmentDistanceHeader = -21;
        const int TextAlignmentDistance = -20;
        ...
        private static StringBuilder CreateTextBuilderWithHeaderInfo(KellerSensorData kellerSensorData)
        {
            ...
            textBuilder.AppendLine($"{"type",TextAlignmentDistanceHeader}{typeText} {mathModName} / ██-█████-██"); //todo: what is 00-00000-00?
            ...
            textBuilder.AppendLine($"{"Version",TextAlignmentDistanceHeader}████████"); //todo: replace unknown with something known
            textBuilder.AppendLine("-----------------------------------------------------------------------");
            textBuilder.AppendLine();
            return textBuilder;
        }
